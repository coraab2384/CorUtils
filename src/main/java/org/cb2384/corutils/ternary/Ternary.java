package org.cb2384.corutils.ternary;
...
public enum Ternary
    ...
    /**
     * Creates a {@link KnownDefaultBooleanContext} specific to {@link Ternary}.
     *
     * @param   defaultValue    the value to use for {@link #DEFAULT} when collapsing a {@link Ternary}
     *                          to a {@code boolean}
     *
     * @return  a concrete {@link KnownDefaultBooleanContext} specialized for {@link Ternary} and with
